...
class ClientTest < Minitest::Test
  def test_table
    assert_nil client.execute("DROP TABLE IF EXISTS users")
    assert_nil client.execute("CREATE TABLE users (id INT, name STRING)")

    skip "Need to debug" if ENV["HIVE_VERSION"]

    assert_nil client.execute("INSERT INTO users VALUES (1, 'Test 1'), (2, 'Test 2'), (3, 'Test 3')")

  ...
  module TCLIService
    class Client
      ...
      def recv_OpenSession()
        ...
        validate_message_begin(fname, mtype, rseqid, 'OpenSession')
      ...
      def recv_CloseSession()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'CloseSession')
      ...
      def recv_GetInfo()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetInfo')
      ...
      def recv_ExecuteStatement()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'ExecuteStatement')
      ...
      def recv_GetTypeInfo()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetTypeInfo')
      ...
      def recv_GetCatalogs()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetCatalogs')
      ...
      def recv_GetSchemas()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetSchemas')
      ...
      def recv_GetTables()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetTables')
      ...
      def recv_GetTableTypes()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetTableTypes')
      ...
      def recv_GetColumns()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetColumns')
      ...
      def recv_GetFunctions()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetFunctions')
      ...
      def recv_GetPrimaryKeys()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetPrimaryKeys')
      ...
      def recv_GetCrossReference()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetCrossReference')
      ...
      def recv_GetOperationStatus()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetOperationStatus')
      ...
      def recv_CancelOperation()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'CancelOperation')
      ...
      def recv_CloseOperation()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'CloseOperation')
      ...
      def recv_GetResultSetMetadata()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetResultSetMetadata')
      ...
      def recv_FetchResults()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'FetchResults')
      ...
      def recv_GetDelegationToken()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'GetDelegationToken')
      ...
      def recv_CancelDelegationToken()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'CancelDelegationToken')
      ...
      def recv_RenewDelegationToken()
        fname, mtype, rseqid = receive_message_begin()
        validate_message_begin(fname, mtype, rseqid, 'RenewDelegationToken')
    ...
    class OpenSession_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TOpenSessionReq}
      }
    ...
    class OpenSession_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TOpenSessionResp}
      }
    ...
    class CloseSession_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TCloseSessionReq}
      }
    ...
    class CloseSession_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TCloseSessionResp}
      }
    ...
    class GetInfo_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetInfoReq}
      }
    ...
    class GetInfo_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetInfoResp}
      }
    ...
    class ExecuteStatement_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TExecuteStatementReq}
      }
    ...
    class ExecuteStatement_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TExecuteStatementResp}
      }
    ...
    class GetTypeInfo_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetTypeInfoReq}
      }
    ...
    class GetTypeInfo_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetTypeInfoResp}
      }
    ...
    class GetCatalogs_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetCatalogsReq}
      }
    ...
    class GetCatalogs_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetCatalogsResp}
      }
    ...
    class GetSchemas_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetSchemasReq}
      }
    ...
    class GetSchemas_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetSchemasResp}
      }
    ...
    class GetTables_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetTablesReq}
      }
    ...
    class GetTables_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetTablesResp}
      }
    ...
    class GetTableTypes_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetTableTypesReq}
      }
    ...
    class GetTableTypes_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetTableTypesResp}
      }
    ...
    class GetColumns_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetColumnsReq}
      }
    ...
    class GetColumns_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetColumnsResp}
      }
    ...
    class GetFunctions_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetFunctionsReq}
      }
    ...
    class GetFunctions_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetFunctionsResp}
      }
    ...
    class GetPrimaryKeys_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetPrimaryKeysReq}
      }
    ...
    class GetPrimaryKeys_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetPrimaryKeysResp}
      }
    ...
    class GetCrossReference_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetCrossReferenceReq}
      }
    ...
    class GetCrossReference_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetCrossReferenceResp}
      }
    ...
    class GetOperationStatus_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetOperationStatusReq}
      }
    ...
    class GetOperationStatus_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetOperationStatusResp}
      }
    ...
    class CancelOperation_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TCancelOperationReq}
      }
    ...
    class CancelOperation_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TCancelOperationResp}
      }
    ...
    class CloseOperation_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TCloseOperationReq}
      }
    ...
    class CloseOperation_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TCloseOperationResp}
      }
    ...
    class GetResultSetMetadata_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetResultSetMetadataReq}
      }
    ...
    class GetResultSetMetadata_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetResultSetMetadataResp}
      }
    ...
    class FetchResults_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TFetchResultsReq}
      }
    ...
    class FetchResults_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TFetchResultsResp}
      }
    ...
    class GetDelegationToken_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TGetDelegationTokenReq}
      }
    ...
    class GetDelegationToken_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TGetDelegationTokenResp}
      }
    ...
    class CancelDelegationToken_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TCancelDelegationTokenReq}
      }
    ...
    class CancelDelegationToken_result
      ...
      FIELDS = {
        SUCCESS_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Hexspace::TCancelDelegationTokenResp}
      }
    ...
    class RenewDelegationToken_args
      ...
      FIELDS = {
        REQ_FIELD_ID => {:type => ::Thrift::Types::STRUCT, :name => 'req', :class => ::Hexspace::TRenewDelegationTokenReq}
      }
